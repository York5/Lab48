...
from webapp.views import index_goods_view, good_create_view, single_good_view, good_edit_view, good_delete_view
...
urlpatterns = [
    ...
    path('good/<int:pk>/edit/', good_edit_view, name='good_edit'),
